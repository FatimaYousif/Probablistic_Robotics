...
class Localization:
    ...
    def Localize(self, xk_1, uk):
        """
        Single Localization iteration invoked from :meth:`prpy.DRLocalization.Localization`.
          Given the previous robot pose, the function reads the inout and computes the current pose.
