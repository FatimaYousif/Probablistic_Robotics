    ...
    **All Robot simulation classes must derive from this class** .
    ...
    def __init__(self, xs0, map=[], * args):
        ...
        * **visualizationInterval** : time-steps interval between two consecutive frames of the animation
        ...
        self.vehicleIcon=VehicleIcon('DifferentialDrive.png', scale = 1, rotation =90) # scale= 5 -> 1 = Image of the robot to be used in the animation. By default it uses the image of a Differential Mobile Robot.
        ...
        self.visualizationInterval = 1 # 20 -> 1 =number of time steps between two visualization updates
